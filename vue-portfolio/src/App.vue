<template>
  <div class="background overflow-x-hidden">
        ...
        clickMode="push"  
      ></vue-particles>
    <section class="snap-start mx-auto max-w-[1080px] min-h-screen">
    ...
    <div class="relative">
      ...
      <div class="text-left pt-20">
        <h1 class="text-white py-2 font-bold text-5xl max-w-3xl">Karl Duggan - Software Tester and Developer</h1>
    ...
    <section class="relative bg-gray-50 text-slate py-32">
      <div class="mx-auto max-w-[1080px]">
